package practiceTestCases;
    ...
    public void Registration_data(String test,String sUserName,String sPassword,String devicename)throws  Exception{
	...
	@Test(dependsOnMethods={"Registration_data"}, dataProvider="Authentication")
	  public void maincode2(String test, String sUserName,String sPassword,String devicename) throws AWTException, InterruptedException, IOException {
	  ...
	  @DataProvider
		public Object[][] Authentication() throws Exception{
	        ...
	        Object[][] testObjArray = ExcelUtils.getTableArray("D://testing//Webdemo//src//testData//TestData.xlsx","Sheet1");
