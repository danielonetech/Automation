...
public class CarwaleTest {
	...
	public void CarCompare() throws Exception {
		...
		/*
		 * System.out.println(arrSplit1[0]); System.out.println(arrSplit1[1]);
		 * System.out.println(arrSplit1[2]); System.out.println(arrSplit1[3]);
		 * System.out.println(arrSplit1[4]); System.out.println(arrSplit1[5]);
		 * System.out.println(arrSplit1[6]);
		 */

		String[] arrSplit2 = car2.split(",");
		/*
		 * System.out.println(arrSplit2[0]); System.out.println(arrSplit2[1]);
		 * System.out.println(arrSplit2[2]); System.out.println(arrSplit2[3]);
		 * System.out.println(arrSplit2[4]); System.out.println(arrSplit2[5]);
		 * System.out.println(arrSplit2[6]);
		 */

		String[] arrSplit3 = car3.split(",");
		/*
		 * System.out.println(arrSplit3[0]); System.out.println(arrSplit3[1]);
		 * System.out.println(arrSplit3[2]); System.out.println(arrSplit3[3]);
		 * System.out.println(arrSplit3[4]); System.out.println(arrSplit3[5]);
		 * System.out.println(arrSplit3[6]);
		 */

		String[] arrSplit4 = car4.split(",");
		/*
		 * System.out.println(arrSplit4[0]); System.out.println(arrSplit4[1]);
		 * System.out.println(arrSplit4[2]); System.out.println(arrSplit4[3]);
		 * System.out.println(arrSplit4[4]); System.out.println(arrSplit4[5]);
