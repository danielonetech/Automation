...
import screendemopage.GooglePage;
...
public class GoogleTest {
	...
	public void Google() throws Exception {
		try {
			Thread.sleep(5000);
			s.rightClick("Capture4.PNG");
			Thread.sleep(1000);
			s.doubleClick("Capture5.PNG");
			Thread.sleep(1000);
			s.hover("Capture6.PNG");
			Thread.sleep(1000);
			s.click("Capture1.PNG");
			// objgo.googleApps();
			Thread.sleep(2000);
			s.click("Capture2.PNG");
			// objgo.Maps();
			Thread.sleep(5000);
			// objgo.Searchbox(search);
			s.type("Capture3.PNG", searchfield);
			Thread.sleep(7000);
